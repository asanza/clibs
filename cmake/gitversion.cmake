...
function(get_repository_version)
  ...
  execute_process(
    COMMAND ${Python_EXECUTABLE} "${SCRIPTS_PATH}/gitversion.py" -b
    "${CMAKE_SOURCE_DIR}"
  ...
  execute_process(
    COMMAND ${Python_EXECUTABLE} "${SCRIPTS_PATH}/gitversion.py" -s
    "${CMAKE_SOURCE_DIR}"
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
  ...
  execute_process(
    COMMAND ${Python_EXECUTABLE} "${SCRIPTS_PATH}/gitversion.py" -a
    "${CMAKE_SOURCE_DIR}"
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
  ...
  execute_process(
    COMMAND ${Python_EXECUTABLE} "${SCRIPTS_PATH}/gitversion.py" -M
    "${CMAKE_SOURCE_DIR}"
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
  ...
  execute_process(
    COMMAND ${Python_EXECUTABLE} "${SCRIPTS_PATH}/gitversion.py" -P
    "${CMAKE_SOURCE_DIR}"
    WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}
